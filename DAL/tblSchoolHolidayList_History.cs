...
namespace DAL
{
    ...
    public partial class tblSchoolHolidayList_History
    {
        public int RecordId_Hist { get; set; }
        public string AddedBy_Hist { get; set; }
        public Nullable<System.DateTime> CreatedDate_utc_Hist { get; set; }
        public Nullable<System.DateTimeOffset> UpdatedDate_Hist { get; set; }
        public Nullable<bool> Record_Status_Hist { get; set; }
